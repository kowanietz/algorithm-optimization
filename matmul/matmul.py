...
_LIB_PATH = os.path.join(os.path.dirname(__file__), "..", "build", "matmul", LIB_NAME)
...
def cblas(a: np.ndarray, b: np.ndarray) -> np.ndarray:
    if a.ndim != 2 or b.ndim != 2:
        raise ValueError("a and b must be 2D arrays")
